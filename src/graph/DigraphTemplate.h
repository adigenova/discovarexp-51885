...
void DotHeader( const Bool label_contigs, const Bool label_vertices,
     const String layout, const double fontsize, const double scale, ostream& out )
{    out << "digraph G {\n\n";
     if (label_vertices)
...
digraphE<F>::PrettyDOT( ostream& out, const vec<double>& lengths,
     ...
     const double fontsize, const double scale ) const
{
     ...
     DotHeader<F>( label_contigs, label_vertices, layout, fontsize, scale, out );
