...
{    
     ...
     {    vec< triple<kmer<M>,int,int> > kmers_plus;
          // cout << Date( ) << ": pass = " << pass 
          //      << ", building kmers_plus, peak mem = " << PeakMemUsageGB( ) 
          // << endl;
          ...
          {    int64_t j;
               ...
               i = j - 1;    }    }
     cout << Date( ) << ": placing reads, peak mem = " << PeakMemUsageGB( ) << endl;
     qvec qv;
...
{    
     ...
     new_stuff.reserve(std::accumulate(mhbp.begin(),mhbp.end(),0ul,
                     ...
                     { nnn += hbv.E();
                       ...
                       return nnn; }));
     cout << "current mem usage = " << MemUsageGB( ) << " GB" << endl; // XXXXXXXXXX
     int K = hb.K( );
     ...
     cout << TimeSince(clock) << " used patching"
          << ", peak mem usage = " << PeakMemUsageGB( ) << " GB" << endl;    }
